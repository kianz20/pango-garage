...
const CATEGORIES = [
  {
    ...
    prompt: "Whichever team's first Rugby World Cup win in this list happened first goes at the top (1995 onward)",
    statLabel: 'Year won',
    format: (v) => String(v),
    minAbsGap: 2,
    minEligible: 4,
  ...
  },
  {
    ...
    prompt: 'From that Rugby World Cup (1995 onward): champion down to 4th place',
    statLabel: 'Final placing',
    format: (v) => ['Champion', 'Runner-up', '3rd place', '4th place'][v - 1],
    minAbsGap: 1,
    pool: RUGBY_FINALISTS,
    display: finalistDisplay,
    note: 'The actual Final Four of one Rugby World Cup (1995 onward): champion, runner-up, 3rd and 4th place.',
  },
];
